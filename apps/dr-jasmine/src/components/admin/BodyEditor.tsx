/**
 * @fileoverview In-place TipTap Body editor for Dr Jasmine Admin Posts.
          ...
          <div className={styles.toolbar} role="toolbar" aria-label="Body formatting">
            ...
            <div className={styles.toolbarGroup}>
              <button
                type="button"
                className={toolButtonClass(
                  editor !== null && editor.isActive("blockquote"),
                )}
                disabled={disabled || editor === null}
                aria-pressed={editor !== null && editor.isActive("blockquote")}
                aria-label="Pull quote or clinic callout"
                title="Quote — start with “In clinic:” for a tip callout"
                onClick={() => {
                  if (editor === null) {
                    return;
                  }
