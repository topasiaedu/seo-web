...
export type LoginFormProps = {
   ...
   * (must include Astro base, e.g. `/dr-jasmine/admin/`).
   */
  redirectTo: string;
};
...
/**
 * Dr Jasmine Admin email/password sign-in form. Login only — no signup link.
 *
  ...
  return (
    <form className="cae-login-form" onSubmit={handleSubmit} noValidate>
      <div className="cae-login-form__field">
        <label className="cae-login-form__label" htmlFor="dj-admin-email">
          Email
        </label>
        <input
          id="dj-admin-email"
      ...
      <div className="cae-login-form__field">
        <label className="cae-login-form__label" htmlFor="dj-admin-password">
          Password
        </label>
        <input
          id="dj-admin-password"
          className="cae-login-form__input"
          name="password"
          type="password"
