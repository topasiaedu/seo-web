/**
 * @fileoverview Dr Jasmine request middleware: Supabase cookie session + Admin auth gate.
 *
 * Protects `/admin/**` under Astro `base: "/dr-jasmine/"` except `/admin/login`.
 ...
 *
 * @param pathname - Full URL pathname (may include base, e.g. `/dr-jasmine/admin`).
