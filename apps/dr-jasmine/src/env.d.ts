...
/**
 * Public and server env vars available to the Dr Jasmine Astro app.
 */
interface ImportMetaEnv {
  readonly PUBLIC_SUPABASE_URL: string;
  readonly PUBLIC_SUPABASE_ANON_KEY: string;
  readonly SUPABASE_SERVICE_ROLE_KEY?: string;
  /** Absolute origin for SEO URLs, e.g. `https://doctorjasmine.com`. */
...
/**
 * Per-request locals attached by `src/middleware.ts` (T4).
 * Blog SSR routes require this client; it is omitted while prerendering.
 */
