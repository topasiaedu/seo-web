/**
 * @fileoverview CAE Admin logout endpoint — clears the Supabase Auth session.
 *
 ...
 * @returns Redirect response to `/cae/admin/login` (respecting base).
 */
export const POST: APIRoute = async ({ locals, redirect }) => {
  ...
  if (error !== null) {
    ...
    console.error("[cae-admin] signOut failed:", error.message);
  }
